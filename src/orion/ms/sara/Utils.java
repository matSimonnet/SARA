...
public class Utils {
	...
	public static void speakDistanceTextView(String value, String unit) {
		if(unit == resource.getString(R.string.m)) {
			MainActivity.tts.speak(resource.getString(R.string.distance) + " " + resource.getString(R.string.to) + " " + MyLocationListener.WaypointName + " is " + value + " " + resource.getString(R.string.metres), TextToSpeech.QUEUE_ADD, null);
		} 
		if(unit == resource.getString(R.string.km)){
			MainActivity.tts.speak(resource.getString(R.string.distance) + " " + resource.getString(R.string.to) + " " + MyLocationListener.WaypointName + " is " + value + " " + resource.getString(R.string.kilometres), TextToSpeech.QUEUE_ADD, null);
		}
		if(unit == resource.getString(R.string.nm)){
			MainActivity.tts.speak(resource.getString(R.string.distance) + " " + resource.getString(R.string.to) + " " + MyLocationListener.WaypointName + " is " + value + " " + resource.getString(R.string.nauticalmiles), TextToSpeech.QUEUE_ADD, null);
		}
	}
